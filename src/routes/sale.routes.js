...
import { validateCreateSale, validateSaleId, validateDate, validateParamsId } from "../validators/sale.validation.js"

import { verifyToken, verifyAdminOrSeller } from "../helpers/jwt.js"

const router = Router();

router.get("/sales/:id", validateParamsId, verifyToken, verifyAdminOrSeller, getSales)
